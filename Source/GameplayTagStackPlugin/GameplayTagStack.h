...
struct GAMEPLAYTAGSTACKPLUGIN_API FGameplayTagStack : public FFastArraySerializerItem
{
	GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct GAMEPLAYTAGSTACKPLUGIN_API FGameplayTagStackContainer : public FFastArraySerializer
{
	GENERATED_BODY()
